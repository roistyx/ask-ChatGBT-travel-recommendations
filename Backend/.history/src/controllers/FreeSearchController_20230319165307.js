	...
	static async Search(req, res) {
		try {
			...
			const response = await openai.createCompletion({
				...
				prompt: `Rephrase this question"${query}" only if it relates to travel and dining, for example: "Certainly, I'd be happy to help with restaurant recommendations. Is that what you had in mind when you asked about where to eat ducks in NYC?"`,
