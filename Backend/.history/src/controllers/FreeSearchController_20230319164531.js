	...
	static async Search(req, res) {
		try {
			...
			const response = await openai.createCompletion({
				...
				prompt: `Rephrase this question"${query}" only if it relates to travel and dining, for example: "What is the best place to visit in Houston?" If it is not related to travel and dining, please say, "I don't know".`,
