	...
	static async Search(req, res) {
		try {
			...
			const response = await openai.createCompletion({
				...
				prompt: `if this question"${query}" asking for recommendations about traveling or dining, return JS array of objects with the best 2 recommendations. For example: [{name: "The Museum of Fine Arts", 
...
If the question is not related to travel return, for example: [{success: false, answer: "This question is not related to travel"}]`,
