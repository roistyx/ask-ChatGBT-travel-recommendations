	...
	static async Search(req, res) {
		try {
			...
			const response = await openai.createCompletion({
				...
				prompt: `if this question"${query}" related to travel or leisure, return JS array of objects with the best 2 recommendations. For example: [{name: "The Museum of Fine Arts", 
