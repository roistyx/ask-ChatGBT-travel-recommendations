	...
	static async Search(req, res) {
		try {
			...
			const response = await openai.createCompletion({
				...
				prompt: ` Find out what is the subject of this question ${query} is related to travel or dining recommendations and rephrase it in a way that the model can understand.`,
