	...
	static async Search(req, res) {
		try {
			...
			const response = await openai.createCompletion({
				...
				prompt: ` Find out what is the subject of this question ${query} is related to travel or dining recommendations. If it is related to travel, then return a JS array of objects of ${query}.
				`,
