	...
	static async Search(req, res) {
		...
		try {
			...
			const response = await openai.createCompletion({
				...
				prompt: `If this question"${query}" is related to travel or leisure, return an array of JS objects with the best 5 recommendations. For example: [{name: "Cafe de Flore", coordinates: [48.863096, 2.332536]}, [{name: "Les Deux Magots", coordinates: [48.859809, 2.334535]}]
