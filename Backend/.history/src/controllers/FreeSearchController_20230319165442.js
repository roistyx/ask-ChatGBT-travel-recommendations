	...
	static async Search(req, res) {
		try {
			...
			const response = await openai.createCompletion({
				...
				prompt: ` politely clarify the intent of the person who asked the question by responding with something like, "Certainly, I'd be happy to help with restaurant recommendations. Is that what you had in mind when you asked about ${query}?
				`,
