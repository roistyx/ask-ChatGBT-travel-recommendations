	...
	static async Search(req, res) {
		try {
			...
			const response = await openai.createCompletion({
				...
				prompt: `Is this question"${query}" asking for recommendations about travel or dining? If yes, return JS array of objects with the best 2 recommendations. For example: [{name: "The Museum of Fine Arts", 
